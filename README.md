...
local Window = OrionLib:MakeWindow({Name = "King Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "king Hub"})
    ...
    spawn(function()
        while wait() do
            ...
            elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709143733" then
                ...
                OrionLib:MakeNotification({
                    Name = "king HUB ",
                    Content = "https://discord.gg/ygKZgRRzqd",
                    Image = "rbxassetid://119980140458596",
                    Time = 5
                })
